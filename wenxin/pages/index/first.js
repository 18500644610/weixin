...
//   data: {
//     imgUrls: [
//       '../../uploads/offline-banner.jpg',
//       '../../uploads/offline-banner.jpg',
//       '../../uploads/offline-banner.jpg'
//     ],
//     array:[
//       {icon:'../../img/homenav1.jpg'},
//       {icon:'../../img/homenav2.jpg'},
//       {icon:'../../img/homenav3.jpg'},
//       {icon:'../../img/homenav4.jpg'},
//     ],
//     array1:[
//     {icon:'../../img/homenav11.jpg'},
//       {icon:'../../img/homenav22.jpg'},
//       {icon:'../../img/homenav33.jpg'},
//       {icon:'../../img/homenav44.jpg'},
//     ],
//     array2:[
...
Page({
  ...
  onLoad:function(options){
    ...
    wx.request({ 
      ...
      success: 
      function(json) { 
         that.setData({'Carousel': json.data})
         } ,
        fail:
        function(res){
          console.log('no')
